...
void Ejes::createArrayData()
{
	...
	colorArray[3] = 1; colorArray[4] = 0; colorArray[5] = 0;	//1,00
	colorArray[6] = 0; colorArray[7] = 1; colorArray[8] = 0;	//0,1,0
	colorArray[9] = 0; colorArray[10] = 1; colorArray[11] = 0;	//0,1,0
	colorArray[12] = 0; colorArray[13] = 0; colorArray[14] = 1;	//0,0,1
	colorArray[15] = 0; colorArray[16] = 0; colorArray[17] = 1;	//0,0,1
