...
public class clientePremium extends cliente {
    ...
    public static Boolean seguro_obra=true;
    public clientePremium(String n, int e, String dni) {
        super(n, e, dni);
    }
     ...
     public void crearTrabajo(float of,String tipo,int num)
     {
            ...
            for(int i=0 ;i<this.sistema.trabajosSistemas.size() && buscado ;i++)
           {
            ...
            if(buscado==true){
                ...
                System.out.println("El cliente PREMIUM "+this.nombre+" ha creado el trabajo con id "+trb.num_trabajo);
