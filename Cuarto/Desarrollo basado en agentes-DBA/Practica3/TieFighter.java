...
public class TieFighter extends LARVAFirstAgent{
    ...
    */
    ...
    public int nextStep(double gps[], int lidar[][] )
    {
        ...
        //Info("Jedi's position\nX=" + jedi[0] + " Y=" +jedi[1]);
        double actualDistance = (jedi[0]-gps[0])*(jedi[0]-gps[0]) + (jedi[1]-gps[1])*(jedi[1]-gps[1]);
        ...
        for(int i=0; i<3;i++)
        {
            ...
            {   
                ...
                if (i!=1 || j!=1){
                        ...
                        {
                            actualDistance = (jedi[0]-gpsX)*(jedi[0]-gpsX) + (jedi[1]-gpsY)*(jedi[1]-gpsY);
    ...
    */
    ...
    public boolean needRecharge(int altitude, double energy){
        ...
        if(altitude == 0)
            ...
            return (energy <= (altitude * mySensors.length)  );
    ...
    */
    public void checkJedis(int y,boolean sube){
        ...
        int anguloActual=myDashboard.getCompass();
        int numChecks=0;
        while(numChecks !=4)
        {
