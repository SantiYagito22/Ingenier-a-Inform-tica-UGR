...
import static p1s2.tecnicoLite.gastosTransporte;

public class tecnicoPremium extends tecnico {

    public static Boolean gastosTransporte=false;
    
    public tecnicoPremium(String n, int e, String dni,  ArrayList<trabajo> trabajos) {
	...
	public void run(){
        ...
        System.out.println("El tecnico PREMIUM "+nombre+" realiza una puja al trabajo con id "+ trabajos.get(numTrb).num_trabajo+" de "+ ofertaRandom);
