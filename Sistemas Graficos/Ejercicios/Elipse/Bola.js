...
class Bola extends THREE.Object3D {
  constructor(gui,titleGui) {
    ...
    var origenAltura={y:-5.0};

    var destinoTangente={x:2*Math.PI,z:2*Math.PI};
    var destinoAltura={y:5.0};
    ...
    .onUpdate(function(){
      ...
      that.esfera.position.z=Math.sin(origenTangente.z)*5.0;
  ...
  update () {
    ...
    this.cilindro.scale.set(this.guiControls.radioCilindro,1,1);
    TWEEN.update();
  }
